...
//       // then parse the JSON.
//       // myName = json.decode(response.body)['name'];

//       // var aaa = response;
//       // print(aaa);
//       // return updateData(aaa);
//       // setState(() {
//       //   // myName = json.decode(response.body);

//       print(json.decode(response.body));
//       //   // myName = jsonDecode(response.body)['name'];
//       //   return Album.fromJson(jsonDecode(response.body));
//       // });
//       // return fatchValue.jsonDecode(response.body)['id'];
...
//       // MaterialPageRoute(
//       //     builder: (context) => const fatchValue.json.decode(response.body));
//       // );
//       // return Album.fromJson(jsonDecode(response.body));
//     } else {
...
//     );
//   }
// // var data1 = EditUserTest(fdata: '', value: '',);
